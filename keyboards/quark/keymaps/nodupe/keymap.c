...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------+-------+-------+-------+-------+-------+------+------+------+------+------+------|
     * | Left Ctrl  | Left Alt | Left Gui| Space/Raise | Space/Lower | R Gui| R Alt | Right Ctrl |
     * `-----------------------------------------------------------------------------------------'
     */
    [0] = LAYOUT_ortho_5x12_2x225u(
        ...
        KC_LSFT, LCTL_T(KC_Z), KC_X,    KC_C,          KC_V,          KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH), KC_ENT ,
        KC_LCTL, KC_LALT,      KC_LGUI, LT(1, KC_SPC), LT(2, KC_SPC), KC_RGUI, KC_RALT, KC_RCTL
    ),
